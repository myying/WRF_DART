...
as1=`echo "$VAR_SCALING1*0.25" |bc -l`,`echo "$LEN_SCALING1*1.0" |bc -l`,`echo "$LEN_SCALING1*1.5" |bc -l`,
as2=`echo "$VAR_SCALING2*0.25" |bc -l`,`echo "$LEN_SCALING2*1.0" |bc -l`,`echo "$LEN_SCALING2*1.5" |bc -l`,
as3=`echo "$VAR_SCALING3*0.25" |bc -l`,`echo "$LEN_SCALING3*1.0" |bc -l`,`echo "$LEN_SCALING3*1.5" |bc -l`,
as4=`echo "$VAR_SCALING4*0.25" |bc -l`,`echo "$LEN_SCALING4*1.0" |bc -l`,`echo "$LEN_SCALING4*1.5" |bc -l`,
as5=`echo "$VAR_SCALING5*0.25" |bc -l`,`echo "$LEN_SCALING5*1.0" |bc -l`,`echo "$LEN_SCALING5*1.5" |bc -l`,
/
&wrfvar8
/
&wrfvar9
